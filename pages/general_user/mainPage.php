    ...
    <div class="d-flex align-items-start">
        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages"
                type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">Group</button>

            <button class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings"
                type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false">Joined</button>

            <button class="nav-link" id="v-pills-job-post-tab" data-bs-toggle="pill" data-bs-target="#v-pills-job-post"
                type="button" role="tab" aria-controls="v-pills-job-post" aria-selected="false">Job Post</button>

            <button class="nav-link" id="v-pills-view-post-tab" data-bs-toggle="pill"
                data-bs-target="#v-pills-view-post" type="button" role="tab" aria-controls="v-pills-view-post"
                aria-selected="false">views Post</button>

               


            <button class="nav-link" id="v-pills-create-post-tab" data-bs-toggle="pill"
                data-bs-target="#v-pills-create-post" type="button" role="tab" aria-controls="v-pills-create-post"
                aria-selected="false">Create Post</button>


                <button class="nav-link" id="v-pills-qus-post-tab" data-bs-toggle="pill"
                data-bs-target="#v-pills-qus-post" type="button" role="tab" aria-controls="v-pills-qus-post"
                aria-selected="false">Qus Bank</button>
        ...
        <div class="tab-content" id="v-pills-tabContent" style="width: 85%!important;">
            ...
            <div class="tab-pane fade" id="v-pills-qus-post" role="tabpanel" aria-labelledby="v-pills-settings-tab"
                tabindex="0">
                <div class="d-flex justify-content-between align-items-center mt-2">
                    <h2 class="w-100 text-center border-bottom-uiu "> View Post</h2> <br>
                    <a href="../pdf/course_catag.php" class="btn btn-uiu"> add course </a>
                    <a href="../pdf/course.php" class="btn btn-uiu"> show course </a>
                    <a href="../pdf/addpost.php" class="btn btn-uiu"> Upload QUS </a>
                    <a href="../pdf/post.php" class="btn btn-uiu">ALL QUS</a>
                </div>
            </div>

        

            <div class="tab-pane fade" id="v-pills-view-post" role="tabpanel" aria-labelledby="v-pills-settings-tab"
                tabindex="0">
                <div class="d-flex justify-content-between align-items-center mt-2">
                    <h2 class="w-100 text-center border-bottom-uiu "> View Post</h2>
                    <a href="../forumRep/views.php" class="btn btn-uiu"> views </a>
                    <a href="pdf/insert.php" class="btn btn-uiu"> QUS BANK </a>
                    <a href="pdf/display_pdf.php" class="btn btn-uiu">QUS views </a>
                </div>
            </div>

            <div class="tab-pane fade" id="v-pills-create-post" role="tabpanel" aria-labelledby="v-pills-settings-tab"
                tabindex="0">
                <div class="d-flex justify-content-between align-items-center mt-2">
                    <a href="../forumRep/post.php" class="btn btn-uiu"> Update Post Or Delete Post </a>
                    <h2 class="w-100 text-center border-bottom-uiu "> Create Post</h2>
                    <a href="../forumRep/add_post.php" class="btn btn-uiu"> Create a New Post </a>
                </div>
            </div>
                ...
                <section class="mt-2" id="form">
                    ...
                    <div class="card border-uiu mb-3" style="max-width: 25rem;">
                        ...
                        <div class="card-footer bg-transparent">
                            ...
                            <form action="post.php" method="post" class="mb-2">
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        <?php echo "id='commentInput{$row["post_id"]}'"; ?> placeholder="text"
                            ...
                            <button type="button" class="btn btn-uiu" data-bs-toggle="modal"
                                <?php echo "data-bs-target='#comment{$row["post_id"]}'"; ?>>
                                View Comments
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" tabindex="-1" <?php echo "id='comment{$row["post_id"]}'"; ?>
            ...
            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab"
                ...
                <aside id="upper" class="d-none">
                    ...
                    <form action="updatePass.php"
                        class="d-flex justify-content-center align-items-center flex-column w-75" method="post">
                        <div class="form-floating w-50">
                            <input type="password" class="form-control" id="currentPassword" placeholder="Password"
                                required name="curr_pass">
                    ...
                    <div class="card-body">
                        <form action="chat.php" class="d-flex flex-column justify-content-center align-items-center"
                            ...
                            <div>
                                ...
                                <a <?php echo "href='delete/leaveForum.php?delete_forum={$a_row["id"]}'" ?>
                                    class="btn btn-uiu text-uppercase">
                                    Leave
                                </a>
                            </div>
                        </form>
            ...
            <div class="tab-pane fade" id="v-pills-job-post" role="tabpanel" aria-labelledby="v-pills-settings-tab"
                tabindex="0">
                <!-- job post -->
                <div class="d-flex justify-content-between align-items-center mt-2">
                        ...
                        <div class="card-footer bg-transparent">
                            ...
                            <form action="job_post.php" method="post" class="mb-2">
                                <div class="form-floating mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        <?php echo "id='commentInput{$qrow["post_id"]}'"; ?> placeholder="text"
                                        name="comment" value="" required>
                            ...
                            <button type="button" class="btn btn-uiu" data-bs-toggle="modal"
                                <?php echo "data-bs-target='#jcomment{$qrow["post_id"]}'"; ?>>
                                View Comments
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" tabindex="-1" <?php echo "id='jcomment{$qrow["post_id"]}'"; ?>
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
